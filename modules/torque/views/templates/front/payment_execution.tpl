<div class="payment_carrier">
   {capture name=path}
        <a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" title="{l s='Go back to the Checkout' mod='torque'}">
            {l s='Checkout' mod='torque'}
        </a>
        <span class="navigation-pipe">{$navigationPipe}</span>
        {l s='Check payment' mod='torque'}
    {/capture}
    ...
    <h1 class="page-heading">{l s='Order summary' mod='torque'}</h1>

    {assign var='current_step' value='payment'}
    {include file="$tpl_dir./order-steps.tpl"}
<div class="torque">
    <form action="{$link->getModuleLink('torque', 'validation', [], true)|escape:'html'}" method="post">
				                        ...
				                        <div class='panel panel-default' id='PaymentBox_de3a227fb470475'>
        			                         <div class='panel-body'>
					                           ...
					                           <div class='col-sm-9 col-md-9 col-lg-9' style='padding:10px;'>
                                                ...
                                                <br></br>
                                                <small>If you don't know how to use Torque, <a href='#'>learn more here</a>. </small>
					                           </div>
											<div class='col-sm-12 col-md-12 col-lg-12'>
